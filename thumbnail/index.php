...
<ol class="breadcrumb">
		<div class="well text-center">
			<h2><b><a href="/"><span style="color: #3498db">Upload Your Thumbnail!</span></h2>
			<hr>
...
<center><i aria-hidden="true" class="fa fa-thumbs-o-up fa-fw"></i> click this <a href="/sub/files" class="btn btn-success" style="line-height: 10px; margin-top: -5px;">button 2x</a> to look your files</div></center>
</div>
</div>
